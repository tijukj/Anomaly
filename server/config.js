...
export const CONFIG = {
  ...
  ANOMALIES: {
    ...
    SPEED_SURGE_DURATION_SEC: 18,
    DOUBLE_OVERDRIVE_MULTIPLIER: 2.0,
    DOUBLE_OVERDRIVE_DURATION_SEC: 20,
    CONTROL_INVERSION_DURATION_SEC: 6,
    VAULT_ACTIVATION_DURATION_SEC: 20,
    TREASURE_RAIN_COUNT: 8,
    TREASURE_RAIN_DURATION_SEC: 20,
    TELEPORT_STORM_DURATION_SEC: 15,
    CYBER_FOG_DURATION_SEC: 22,
    CYBER_FOG_RADIUS: 140,
    GOLDEN_CROWN_DURATION_SEC: 25,
